...
export class TableUserDetails1727440005404 implements MigrationInterface {
    name = 'TableUserDetails1727440005404'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying NOT NULL, "email" character varying NOT NULL, "password" text NOT NULL, "status" character varying(13) NOT NULL DEFAULT 'ACTIVE', "datail_id" uuid NOT NULL, CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "REL_e9a87388523f59c099c5085b8f" UNIQUE ("datail_id"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
